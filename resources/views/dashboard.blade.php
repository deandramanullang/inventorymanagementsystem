@extends('layouts.app', ['pageSlug' => 'dashboard', 'page' => 'Samoyed Beauty', 'section' => ''])
...
@section('content')
                ...
                <div class="card-header ">
                    <div class="row">
                        <div class="col-sm-6 text-left">
                            <h5 class="card-category">Jumlah Penjualan</h5>
                            <h2 class="card-title">Pendapatan Tahunan</h2>
                        </div>
                        <div class="col-sm-6">
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card card-chart">
                <div class="card-header">
                    <h5 class="card-category">Pendapatan Bulan Lalu</h5>
        ...
        <div class="col-lg-4">
            <div class="card card-chart">
                <div class="card-header">
                    <h5 class="card-category">Laporan Bulanan</h5>
